...
1. Get Code: `git clone https://github.com/KhulnaSoft/dashworks.git`
2. Navigate into the directory: `cd dashworks`
...
![File Breakdown](https://raw.githubusercontent.com/KhulnaSoft/dashworks/master/docs/assets/repo-visualization.svg)
