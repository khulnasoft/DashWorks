...
$HTTP["host"] == "dashworks.my-domain.net" {
  server.document-root = "/home/lighttpd/dashworks.my-domain.net/http"
  server.errorlog = "/var/log/lighttpd/dashworks.my-domain.net/error.log"
  accesslog.filename = "/var/log/lighttpd/dashworks.my-domain.net/access.log"
  auth.require = (
    "/docs/" => (
      "method" => "basic",
