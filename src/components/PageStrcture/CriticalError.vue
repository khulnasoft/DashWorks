  ...
  <div class="critical-error-wrap" v-if="shouldShow">
    ...
    <ul>
      <li>Check the browser console for more details
        (<a href="https://github.com/KhulnaSoft/dashworks/blob/master/docs/troubleshooting.md#how-to-open-browser-console">see how</a>)
      </li>
      <li>View the
        <a href="https://github.com/KhulnaSoft/dashworks/blob/master/docs/troubleshooting.md">Troubleshooting Guide</a>
        and <a href="https://dashworks.khulnasoft.com/docs/">Docs</a>
      </li>
      <li>
        ...
        then <a href="https://github.com/KhulnaSoft/dashworks/issues/new/choose">open a ticket on GitHub</a>
      </li>
