module.exports = {
  ...
  backupEndpoint: 'https://dashworks-sync-service.as93.net',
  ...
  pwa: {
    ...
    iconPaths: {
      ...
      maskIcon: './web-icons/dashworks-logo.png',
      msTileImage: './web-icons/dashworks-logo.png',
    },
  },
};
